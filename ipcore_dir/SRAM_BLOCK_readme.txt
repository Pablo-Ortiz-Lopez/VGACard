...
/home/pablo/ise/VGA/ipcore_dir:
   ...
   - SRAM_BLOCK_flist.txt:
        Text file listing all of the output files produced when a customized
        core was generated in the CORE Generator.

   - SRAM_BLOCK_readme.txt:
   ...
   - SRAM_BLOCK.gise and SRAM_BLOCK.xise:
        ISE Project Navigator support files. These are generated files and
        should not be edited directly.

   - SRAM_BLOCK directory.

In the SRAM_BLOCK directory, three folders are created:
   - docs:
